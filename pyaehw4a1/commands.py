...
class ReadCommand(Enum):
    status_3_0 = bytes([
        0xF4, 0xF5, 0x00, 0x40, 0x0B, 0x00, 0x00, 0x01, 0x01, 0xFE, 0x01,
        0x00, 0x00, 0x03, 0x00, 0x00, 0x01, 0x4F, 0xF4, 0xFB
        ])
    status_3_1 = bytes([
        0XF4, 0XF5, 0X00, 0X40, 0X0B, 0X00, 0X00, 0X01, 0X01, 0XFE, 0X01,
        0X00, 0X00, 0X03, 0X01, 0X00, 0X01, 0X50, 0XF4, 0XFB
        ])
    status_7_1 = bytes([
        0XF4, 0XF5, 0X00, 0X40, 0X0B, 0X00, 0X00, 0X01, 0X01, 0XFE, 0X01,
        0X00, 0X00, 0X07, 0X01, 0X00, 0X01, 0X54, 0XF4, 0XFB
        ])
    status_10_4 = bytes([
        0XF4, 0XF5, 0X00, 0X40, 0X0B, 0X00, 0X00, 0X01, 0X01, 0XFE, 0X01,
        0X00, 0X00, 0X0A, 0X04, 0X00, 0X01, 0X5A, 0XF4, 0XFB
        ])
    status_102_0 = bytes([
    ...
    status_102_64 = bytes([
        0xF4, 0xF5, 0x00, 0x40, 0x0B, 0x00, 0x00, 0x01, 0x01, 0xFE, 0x01,
        0x00, 0x00, 0x66, 0x40, 0x00, 0x01, 0xF2, 0xF4, 0xFB
        ])
